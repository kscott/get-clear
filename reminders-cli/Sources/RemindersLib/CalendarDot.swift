// CalendarDot.swift
// Renders a colored bullet from a hex color string for list and find output.
...
public func calendarDot(hex: String?) -> String {
    guard ANSI.enabled, let hex = hex, hex.count == 6 else { return "  " }
